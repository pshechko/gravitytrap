...
function add_admin_jquery_ui($hook) {
	...
	wp_enqueue_script( 'jquery-ui-sortable', PLUGINURI . '/admin/gravitySortable/gravitySortable.js', array('jquery'));
	wp_enqueue_style('jquery-ui-sortable-stylesheet', PLUGINURI . '/admin/gravitySortable/gravitySortable.css');
...
function add_admin_gravitytrap_page_assets($hook) {
	...
	wp_enqueue_script( 'gravitytrap-script', PLUGINURI . '/admin/js/page.js', array('jquery','jquery-ui-sortable'));
}
