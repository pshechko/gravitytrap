...
class GFEntryDetail {
	...
	public static function lead_detail_page() {
		...
		/**
		 * A filter to enable or disable payment details in an entry
		 *
					...
					<td class="entry-detail-note<?php echo $is_last ? ' lastrow' : '' ?>">
						...
						<div style="margin-top:4px;">
							<div class="note-avatar"><?php
								 ...
								 *
								 * @param array $notes The Note object that is being filtered when modifying the avatar
								 */
				...
				<div id="submitcomment" class="submitbox">
					<div id="minor-publishing" style="padding:10px;">
						...
						if ( ! empty( $payment_status ) ){
							...
							/**
							 * Filter through the way rhe Payment Amount is rendered
							 *
